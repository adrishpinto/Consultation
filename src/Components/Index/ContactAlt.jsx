...
import { Instagram, Globe, Linkedin, MapPin, Phone, Mail, Send } from "lucide-react";
...
const Contact = () => {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(160deg, #faf7f5 0%, #f3ece8 50%, #e8d8e2 100%)",
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, #C6AFC3, transparent 70%)" }}
      />
      <div
        className="absolute bottom-[10%] left-[5%] w-[300px] h-[300px] rounded-full opacity-15 pointer-events-none"
        style={{ background: "radial-gradient(circle, #AD93A9, transparent 70%)" }}
      />
            ...
            {[
              ...
              <div key={label} className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-[14px] leading-relaxed opacity-90">{value}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <img
        src={coach}
        alt="coach"
        className="absolute bottom-0 left-[-40px] h-[440px] object-contain scale-x-[-1] pointer-events-none"
